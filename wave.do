...
quietly virtual function -install /test3DRS/DUT/swaddrgen -env /test3DRS/#INITIAL#54 { &{/test3DRS/DUT/swaddrgen/UWpos[13], /test3DRS/DUT/swaddrgen/UWpos[12], /test3DRS/DUT/swaddrgen/UWpos[11], /test3DRS/DUT/swaddrgen/UWpos[10], /test3DRS/DUT/swaddrgen/UWpos[9], /test3DRS/DUT/swaddrgen/UWpos[8], /test3DRS/DUT/swaddrgen/UWpos[7] }} UWpos_y
quietly virtual function -install /test3DRS/DUT/swaddrgen -env /test3DRS/#INITIAL#54 { &{/test3DRS/DUT/swaddrgen/UWpos[6], /test3DRS/DUT/swaddrgen/UWpos[5], /test3DRS/DUT/swaddrgen/UWpos[4], /test3DRS/DUT/swaddrgen/UWpos[3], /test3DRS/DUT/swaddrgen/UWpos[2], /test3DRS/DUT/swaddrgen/UWpos[1], /test3DRS/DUT/swaddrgen/UWpos[0] }} UWpos_x
...
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/UW_ROW
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/UW_COL
...
add wave -noupdate -format Literal /test3DRS/DUT/reg_search/write_count
add wave -noupdate -format Literal /test3DRS/DUT/reg_search/R_ROW
add wave -noupdate -format Literal /test3DRS/DUT/reg_search/R_COL
add wave -noupdate -format Literal /test3DRS/DUT/reg_search/row
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {75470897 ps} 0}
...
update
WaveRestoreZoom {77821058 ps} {78956787 ps}
